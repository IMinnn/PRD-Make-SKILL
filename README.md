...
前提是已经拥有较成熟、经过确认的产品方案。

否则建议先使用 pm-make。

---

### 产品定型稿能直接用于 AI Coding 吗？

可以。

这本来就是 pm-make 的设计目标之一。
...
而涉及产品边界、业务规则、权限策略和核心流程时，优先暴露问题，而不是替你拍板。

毕竟：

> PRD 可以重写，错误的产品决策往往更难回头。

---

这个版本已经比较接近 GitHub 上成熟开源项目的 README 风格了：既有产品理念，也有完整安装与使用说明；既能让第一次接触的人快速理解，也能让用户照着文档直接安装和使用。
